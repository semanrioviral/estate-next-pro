...
export default function CatalogHeader({
    ...
    return (
        <section className="bg-white pt-24 pb-12 relative border-b border-border-clean">
            <div className="container-wide px-4">
                {/* Breadcrumbs & Badge */}
                <div className="flex flex-col items-center mb-8">
                    <nav className="flex items-center text-[10px] font-black text-text-secondary uppercase tracking-[0.2em] mb-6">
                        ...
                        {breadcrumbs.map((bc, index) => (
                            <React.Fragment key={index}>
                                <ChevronRight className="w-3 h-3 mx-2 text-text-muted" />
                                {bc.href ? (
                    ...
                    {badge && (
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-bg-alt border border-border-clean rounded-full mb-6">
                ...
                <div className="max-w-4xl mx-auto text-center mb-12">
                    <h1 className="mb-4 leading-tight text-slate-900 tracking-tight">
                        {title}
                    </h1>
                    {description && (
                        <div className="text-base md:text-lg text-text-secondary font-medium max-w-2xl mx-auto leading-relaxed">
                            {description}
                        </div>
                    )}
                </div>
                ...
                <div className="w-full max-w-6xl mx-auto relative z-20 mb-12">
                    <div className="py-2">
                ...
                <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-end justify-between gap-8 pt-8 border-t border-slate-100">
